...
def add_generation_args(parser):
    ...
    group.add_argument('--save-example', type=str,
                       help='Path to save training data examples')
    group.add_argument('--example', type=str,
                       help='Path to load training data examples')
    group.add_argument('--val', type=str,
                       help='Path to load training data examples')
